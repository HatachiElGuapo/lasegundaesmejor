...
const FEATURED = [
  { slug: 'blazer-vintage-camel', name: 'Blazer Camel Vintage',  price: 85000,  size: 'M'  as const, category: 'outerwear' as const, condition: 'vintage'   as const, height: '420px' },
  { slug: 'falda-midi-plisada',   name: 'Falda Midi Plisada',    price: 62000,  size: 'S'  as const, category: 'bottoms'   as const, condition: 'excelente' as const, height: '340px' },
  { slug: 'camisa-lino-blanca',   name: 'Camisa de Lino Blanca', price: 48000,  size: 'L'  as const, category: 'tops'      as const, condition: 'buena'     as const, height: '380px' },
  { slug: 'abrigo-lana-gris',     name: 'Abrigo de Lana Gris',   price: 140000, size: 'M'  as const, category: 'outerwear' as const, condition: 'excelente' as const, height: '460px' },
];
